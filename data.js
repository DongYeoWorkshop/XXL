...
export const charData = {
  ...
  "baade": {
    ...
    skills: [
...

      {
        ...
        isUltExtra: true,
        damageDeal: [{ type: "추가공격", val: { stampMax: 174.75 } }]
      }
    ]
  },
  "anuberus": {
    ...
    skills: [
      ...
      },
      {
        ...
        damageDeal: [{ type: "추가공격", val: { stampMax: 30 } }]
      }
    ]
  },
  "kumoyama": {
  ...
  "jetblack": {
    ...
    skills: [
      ...
      },
      {
        ...
        hasToggle: true,
        toggleType: "isAppliedStamped",
        icon: "images/sigilwebp/sigil_jetblack.webp",
        calc: [{ max: 30 }]
      },
    ]
  },
  ...
  "yuzhan": {
    title: "임욱잠",
    base: { "공격력": 535, "HP": 2333 },
    info: { "속성": 0, "포지션": "전사" },
    defaultBuffSkills: ["yuzhan_skill3", "yuzhan_skill5", "yuzhan_skill6", "yuzhan_skill7"],
    skills: [
      {
        id: "yuzhan_skill1",
        excludeFromBuffSearch: true,
      ...
      },
      {
        ...
        name: "폭죽 대난사",
        icon: "icon/attack(strong).webp",
        desc: "(쿨타임 : 3턴) \n 대상 단일에게 공격력의 {0}% 데미지를 주며, 적 전체에겐 {1}%의 데미지를 줌",
        stampDesc: "(쿨타임 : 3턴) \n 대상 단일에게 공격력의 {0}% 데미지를 주며, 적 전체에겐 {1}%의 데미지를 줌\n* 도장 패시브 : 자신을 제외한 전사, 방해 포지션에 해당하는 아군이 보통공격 시 50% 확률로 대상에게 [화약]을 1스택 부여하며, 임욱잠이 필살기 사용 시 대상의 [화약] 스택 수에 따라 적 전체에게 공격력 {2}%의 추가데미지를 주고 스택을 모두 소모",
        calc: [{ max: 100 }, { max: 50 }, { max: 0, stampMax: 30 }],
        damageDeal: [{ type: "필살공격", val: { max: 100 }, isSingleTarget: true }, { type: "필살공격", val: { max: 50 } }]
      },
      { id: "yuzhan_skill3", excludeFromBuffSearch: true, decimalPlaces: 2, buffEffects: { "공증": { max: 30 } }, buffDesc: "공격력 {0}% 증가", name: "공격강화Ⅳ", icon: "icon/passive2.webp", desc: "자신의 공격력 {0}% 증가", calc: [{ max: 30 }] },
      {
        id: "yuzhan_skill4",
        excludeFromBuffSearch: true,
        decimalPlaces: 2,
        name: "불꽃과 농포 여화",
        icon: "icon/passive2.webp",
        desc: "보통공격 시 대상에게 [화약](최대 3스택)을 1스택 부여하며, 대상이 가진 [화약] 스택 수에 따라 보통공격 시 공격력 {0}%의 데미지를 줌",
        calc: [{ max: 15 }],
        damageDeal: [{ type: "추가공격", val: { max: 15 } }]
      },
      {
        id: "yuzhan_skill5",
        excludeFromBuffSearch: true,
        decimalPlaces: 2,
        buffEffects: { "트리거뎀증": { max: 30 } },
        hasToggle: true,
        toggleType: "isAppliedStamped",
        buffDesc: "발동스킬의 효과 {0}% 증가",
        name: "화약 장전",
        icon: "icon/passive5.webp",
        desc: "방어 시 2턴 간 자신의 발동 스킬 효과 {0}% 증가",
        calc: [{ max: 30 }]
      },
      { id: "yuzhan_skill6", excludeFromBuffSearch: true, decimalPlaces: 2, buffEffects: { "기초공증": { max: 15 }, "기초HP증가": { max: 15 } }, buffDesc: "기초공격력/HP {0}% 증가", name: "고강도 훈련 성과", icon: "icon/passive5.webp", desc: "자신의 기초 공격력, 기초 HP {0}% 증가", calc: [{ max: 15 }] },
      {
        id: "yuzhan_skill7",
        excludeFromBuffSearch: true,
        decimalPlaces: 2,
        buffEffects: { "뎀증": { max: 18 } },
        buffDesc: "[화약] 3스택 일 시 데미지 {0}% 증가",
        name: "최고의 불꽃을 보여 주지!",
        hasToggle: true,
        toggleType: "isAppliedStamped",
        icon: "icon/passive5.webp",
        desc: "공격 대상이 [화약] 3스택일 경우 임욱잠이 주는 데미지 {0}% 증가",
        calc: [{ max: 18 }]
      },
      {
        id: "yuzhan_skill8",
  ...
  "suichong": {
    ...
    base: { "공격력": 592, "HP": 2791 },
    info: { "속성": 3, "포지션": "전사" },
    defaultBuffSkills: ["suichong_skill1", "suichong_skill2", "suichong_skill3", "suichong_skill5", "suichong_skill6", "suichong_skill8"],
    skills: [
      {
        id: "suichong_skill1",
        excludeFromBuffSearch: true,
      ...
      },
      {
        ...
        toggleType: "isAppliedStamped",
        icon: "icon/attack(strong).webp",
        buffEffects: { "공증": { max: 60 } },
        buffDesc: "공격력 {0}% 증가",
        desc: "(쿨타임 : 2턴) \n 1턴간 자신의 공격력 {0}% 증가",
        stampDesc: "(쿨타임 : 2턴) \n 1턴간 자신의 공격력 {0}% 증가\n* 도장 패시브 : [서인]의 스택 수가 1스택일 때 행동 시 50% 확률로 2턴 간 아군 전체에게 공격력 {1}% 증가를 부여하며, [서인]의 스택 수가 2중첩 이상일 경우 동일한 버프를 50% 확률로 한번 더 부여",
        calc: [{ max: 60 }, { max: 7.5 }],
      },
      {
        id: "suichong_skill3",
      ...
      },
      {
        ...
        name: "사악함을 제압하는 길상",
        icon: "icon/passive2.webp",
        desc: "1턴 경과할 때마다 [서인](최대 4스택)을 1스택을 쌓으며, 필살기 발동 시 [서인]을 모두 소모하며 [서인]이 3스택일 경우 공격력 {0}%의 추가데미지를 1회 주며 4스택일 경우 2회 발동됨, 그리고 세숭이 보통공격 발동 시 대상에게 공격력 {1}%의 추가데미지를 주며, 필살기 발동 시엔 대상에게 공격력 {2}%의 추가데미지를 줌",
        calc: [{ max: 30 }, { max: 100 }, { max: 200, startRate: 0.64 }],
      ...
      },
      {
        ...
        name: "석숭의 비늘",
        icon: "icon/passive5.webp",
        desc: "방어 사용 시 5턴 간 데미지 {0}% 증가(최대 2중첩), 필살기 사용 시 패시브3의 버프를 모두 제거",
        calc: [{ max: 15 }],
      },
      { id: "suichong_skill6", excludeFromBuffSearch: true, decimalPlaces: 2, buffEffects: { "기초공증": { max: 15 }, "기초HP증가": { max: 15 } }, buffDesc: "기초공격력/HP {0}% 증가", name: "고강도 훈련 성과", icon: "icon/passive5.webp", desc: "자신의 기초 공격력, 기초 HP {0}% 증가", calc: [{ max: 15 }] },
      {
        id: "suichong_skill7",
        excludeFromBuffSearch: true,
        hasStampEffect: true,
        decimalPlaces: 2,
        stampBuffEffects: { "추가데미지": { max: 25, startRate: 0.64 } },
        buffDesc: "보통공격 시 {0}% 추가 데미지",
        name: "세월의 흐름",
        icon: "icon/passive5.webp",
        desc: "필살기 사용 시 아군 전체에게 2턴 간 [추말]을 부여하며, [추말]을 가진 대상은 보통공격 시 {0}%의 추가데미지를 주며, 필살기 사용 시 {1}%의 추가데미지를 줌",
        calc: [{ max: 25, startRate: 0.64 }, { max: 50, startRate: 0.64 }],
        damageDeal: [{ type: "추가공격", val: { max: 25, startRate: 0.64 } }]
      },
      {
        id: "suichong_skill8",
        name: "세월을 비추는 황금빛",
        decimalPlaces: 2,
        buffEffects: { "공증": { max: 7.5 } },
        buffDesc: "[서인]공격력 {0}% 증가",
        hasCounter: true,
        counterRange: { min: 0, max: 2 },
        icon: "images/sigilwebp/sigil_suichong.webp",
        excludeFromBuffSearch: false,
        isUltExtra: true,
        syncLevelWith: "suichong_skill2",
        calc: [{ max: 7.5 }],
      },
      {
        id: "suichong_skill9",
        ...
        hasStampEffect: true,
        decimalPlaces: 2,
        syncLevelWith: "suichong_skill7",
        stampBuffEffects: { "추가데미지": { max: 50, startRate: 0.64 } },
        buffDesc: "필살기 사용 시 {1}% 추가 데미지",
        name: "세월의 흐름(필살)",
        icon: "icon/passive5.webp",
        calc: [{ max: 25, startRate: 0.64 }, { max: 50, startRate: 0.64 }],
        damageDeal: [{ type: "추가공격", val: { max: 50, startRate: 0.64 } }]
      },
      {
        id: "suichong_skill10",
        excludeFromBuffSearch: true,
        decimalPlaces: 2,
        syncLevelWith: "suichong_skill4",
        name: "사악함을 제압하는 길상(필살)",
        icon: "icon/passive2.webp",
        calc: [{ max: 200, startRate: 0.64 }],
        damageDeal: [{ type: "추가공격", val: { max: 200, startRate: 0.64 } }]
      },
      {
        id: "suichong_skill11",
        excludeFromBuffSearch: true,
  ...
  "souran": {
    ...
    info: { "속성": 2, "포지션": "전사" },
    defaultBuffSkills: ["souran_skill3", "souran_skill5", "souran_skill6", "souran_skill7", "souran_skill8"],
    skills: [
      {
        id: "souran_skill1",
        excludeFromBuffSearch: true,
      ...
      },
      {
        ...
        name: "폭풍아 연속난무참",
        icon: "icon/attack(strong).webp",
        desc: "(쿨타임 : 2턴) \n 목표물에게 공격력 {0}%의 데미지를 줌",
        stampDesc: "(쿨타임 : 2턴) \n 목표물에게 공격력 {0}%의 데미지를 줌 \n* 도장 패시브 : 란이 가진 [해일의 송곳니]가 5스택 이상일 경우, 보통공격 시 50% 확률로 {1}%의 추가데미지를 주고 자신에게 [해일의 송곳니] 2스택 부여",
        calc: [{ max: 125.25, stampMax: 167 }, { max: 50 }],
        damageDeal: [{ type: "필살공격", val: { max: 125.25, stampMax: 167 } }]
      },
      {
        id: "souran_skill3",
        excludeFromBuffSearch: true,
      ...
      },
      {
        ...
        name: "순영 연속물어뜯기",
        icon: "icon/passive2.webp",
        desc: "행동 시 자신에게 [해일의 송곳니]를 2스택 부여하며 또한 보통공격 시 50% 확률로 {0}%의 추가데미지를 주고 자신에게 [해일의 송곳니] 2스택 부여, 필살기 사용 시 자신이 가진 [해일의 송곳니] 스택 수 만큼 {1}%의 추가데미지를 준 후 [해일의 송곳니] 제거 \n*[해일의 송곳니] 최대 16스택(30턴)",
        calc: [{ max: 80 }, { fixed: 13.05 }],
        damageDeal: [{ type: "추가공격", val: { max: 80 } }],
      },
      {
        id: "souran_skill5",
        ...
        hasToggle: true,
        toggleType: "isAppliedStamped",
        ratioEffects: { "고정공증": { from: "기초공격력", max: 24 } },
        buffDesc: "란의 기초공격력 {0}%만큼 공격력 가산",
        name: "허물 매미 교전",
        icon: "icon/passive5.webp",
        desc: "필살기 사용 시 [란의 기운]이 발동되며, [란의 기운]이 있는 상태에서 방어 시 스택을 소모해 네번째 위치에 있는 아군에게 해당 아군 자신의 기초공격력 {0}%만큼 공격력 가산(1턴)을 부여하며, 해당 아군이 공격 시 발동스킬 데미지 {1}% 증가 버프(2턴)와 [해일의 송곳니] 5스택을 란에게 부여",
        calc: [{ max: 24 }, { max: 108 }]
      },
      {
        id: "souran_skill6",
      ...
      },
      {
        ...
        excludeFromBuffSearch: true,
        decimalPlaces: 2,
        buffEffects: { "트리거뎀증": { max: 45, startRate: 0.2 } },
        buffDesc: "추가데미지의 데미지 {0}% 증가",
        hasToggle: true,
        toggleType: "isAppliedStamped",
        name: "전장의 여운",
        icon: "icon/passive5.webp",
        desc: "필살기 사용 시 자신에게 [해일의 송곳니] 5중첩 부여, 행동 시 50% 확률로 자신에게 3턴 간 발동스킬 효과 {0}% 증가 부여",
        calc: [{ max: 45, startRate: 0.2 }]
      },
      {
        id: "souran_skill8",
        name: "허물 매미 교전[버프]",
        excludeFromBuffSearch: true,
        decimalPlaces: 2,
        syncLevelWith: "souran_skill5",
        icon: "icon/passive5.webp",
        buffEffects: { "트리거뎀증": { max: 108 } },
        buffDesc: "추가데미지의 데미지 {0}% 증가",
        hasToggle: true,
        toggleType: "isAppliedStamped",
        calc: [{ max: 108 }]
      },
      {
        ...
        name: "폭풍아 연속난무참",
        decimalPlaces: 2,
        stampBuffEffects: { "추가데미지": { max: 50 } },
        icon: "images/sigilwebp/sigil_souran.webp",
        excludeFromBuffSearch: true,
        isUltExtra: true,
        syncLevelWith: "souran_skill2",
        calc: [{ max: 50 }],
        damageDeal: [{ type: "추가공격", val: { max: 50 } }]
      },
      {
        ...
        excludeFromBuffSearch: true,
        decimalPlaces: 2,
        syncLevelWith: "souran_skill4",
        name: "순영 연속물어뜯기[해일의 송곳니]",
        icon: "icon/passive2.webp",
        calc: [{ fixed: 13.05 }],
        damageDeal: [{ type: "추가공격", val: { fixed: 13.05 } }]
      },
